...
// Source: github.com/abhinav/git-fu/service (interfaces: PR,Review)
...
// Mock of Review interface
type MockReview struct {
	ctrl     *gomock.Controller
	recorder *_MockReviewRecorder
}

// Recorder for MockReview (not exported)
type _MockReviewRecorder struct {
	mock *MockReview
}

func NewMockReview(ctrl *gomock.Controller) *MockReview {
	mock := &MockReview{ctrl: ctrl}
	mock.recorder = &_MockReviewRecorder{mock}
	return mock
}

func (_m *MockReview) EXPECT() *_MockReviewRecorder {
	return _m.recorder
}

func (_m *MockReview) ReviewStatus(_param0 context.Context, _param1 int) (*service.ReviewStatus, error) {
	ret := _m.ctrl.Call(_m, "ReviewStatus", _param0, _param1)
	ret0, _ := ret[0].(*service.ReviewStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockReviewRecorder) ReviewStatus(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ReviewStatus", arg0, arg1)
}
